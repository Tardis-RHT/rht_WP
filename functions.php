...
add_action('init', 'create_post_type_furniture');
// Remove Actions
...
function create_post_type_furniture()
{
    register_taxonomy_for_object_type('category', 'html5-blank'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'html5-blank');
    register_post_type('html5-furniture', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Фурнитура', 'furniture'), // Rename these to suit
            'singular_name' => __('HTML5 Blank Custom Post', 'furniture'),
            'add_new' => __('Add New', 'furniture'),
            'add_new_item' => __('Add New HTML5 Blank Custom Post', 'furniture'),
            'edit' => __('Edit', 'furniture'),
            'edit_item' => __('Edit HTML5 Blank Custom Post', 'furniture'),
            'new_item' => __('New HTML5 Blank Custom Post', 'furniture'),
            'view' => __('View HTML5 Blank Custom Post', 'furniture'),
            'view_item' => __('View HTML5 Blank Custom Post', 'furniture'),
            'search_items' => __('Search HTML5 Blank Custom Post', 'furniture'),
            'not_found' => __('No HTML5 Blank Custom Posts found', 'furniture'),
            'not_found_in_trash' => __('No HTML5 Blank Custom Posts found in Trash', 'furniture')
        ),
        'public' => true,
